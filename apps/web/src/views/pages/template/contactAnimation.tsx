...
export default function ContactAnimation({ mounted }: { mounted: boolean }) {
  return (
    <section
      className={`${antonFont.className} relative text-7xl sm:text-8xl uppercase tracking-tight text-light bg-orange-800 py-12 cursor-pointer transition-all duration-500 ${
