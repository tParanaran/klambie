...
export default function ContactAnimation({ mounted }: { mounted: boolean }) {
  return (
    <section
      className={`${antonFont.className} relative text-7xl md:text-8xl uppercase tracking-tight text-[#ededed] bg-orange-800 py-12 cursor-pointer transition-all duration-500 ${
