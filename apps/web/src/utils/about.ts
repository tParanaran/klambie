...
export const missions = [
  {
    label: 'Mission',
    text: 'We are on a mission to provide a seamless shopping experience by curating high-quality products from trusted brands while creating our own designs that reflect real style and individuality.',
    icon: IoGlobe,
  },
  {
    label: 'Vission',
    text: '  We are challenging to become a go-to destination for modern fashion, known for blending curated brands with original creations that inspire confidence and self-expression.',
    icon: IoEarth,
  },
];

export const aboutText = `Klambie blends handpicked products from established brands with our
