/*
  ...
  - Made the column `productId` on table `product_image` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE `product_image` MODIFY `productId` INTEGER NOT NULL;
